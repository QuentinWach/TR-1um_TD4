...
| | 手選び 10 本 | 自動判定 | **+ 移植 10〜13** |
|---|---:|---:|---:|
| 短絡 | 16 | 2 | **0** |
| M1/M2 width/space | 0 | 0 | **0** |
| V1 space | 1 | 1 | **0** |
| V1 の M1/M2 囲み・V1-GC | 0 | 0 | **0** |
| 圧縮後コア高 | 1131.1 | 1127.0 | **1137.8 µm** |

コア高は 10.8 µm（トラック 2 本）増えたが、**短絡 0 / DRC 0**。
チップ側コア高は 1137.8 + 561.6（マクロ帯）= **1699.4 µm**、開口 1840 に
対し余り 70.3 µm/側。
